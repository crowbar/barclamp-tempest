...
class TempestService < ServiceObject
  ...
  def apply_role_pre_chef_call(old_role, role, all_nodes)
    ...
    unless nodes.nil? or nodes.length < 1
      ...
      tempest_test_docker_image_path = role.default_attributes["tempest"]["tempest_test_docker_image"].gsub("<ADMINWEB>", "#{admin_ip}:#{web_port}")
      ...
      role.default_attributes["tempest"]["tempest_test_docker_image"] = tempest_test_docker_image_path
    end
